...
import { X, Eye, EyeOff, Mail, Lock, User, Phone, UserCheck, Heart } from 'lucide-react';
        ...
        <div className="relative p-6 border-b border-gray-100">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl font-bold text-gray-800">
              {mode === 'login' ? 'Welcome Back!' : 'Join PetBnB'}
            </h2>
            <p className="text-gray-600">
              {mode === 'login' 
                ? 'Sign in to your account to continue' 
                : 'Create your account and start connecting with pet caregivers'
              }
            </p>
          </div>
        </div>
          ...
          {mode === 'register' && (
            <div className="form-group">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  type="button"
                  onClick={() => handleInputChange({ target: { name: 'role', value: 'caregiver' } })}
                  className={`p-4 border-2 rounded-xl text-center space-y-2 transition-all ${
                ...
                >
                  <UserCheck className="h-6 w-6 mx-auto" />
                  <div className="font-medium">Pet Caregiver</div>
            ...
            <div className="form-group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="+60 or +65 phone number"
                />
              </div>
            </div>
          )}
