...
// Disabled notification service for Expo Go development
// This will be re-enabled when we build for production
...
class NotificationService {
  ...
  async initialize() {
    console.log('Notifications disabled in Expo Go development');
    return false;
  }

  setupListeners(navigation) {
    console.log('Notification listeners disabled in development');
  }
  ...
  async scheduleLocalNotification(title, body, data = {}, scheduledTime = null) {
    console.log('Local notification disabled in development:', title);
    return null;
  }

  async cancelNotification(notificationId) {
    console.log('Cancel notification disabled in development');
  }

  async cancelAllNotifications() {
    console.log('Cancel all notifications disabled in development');
  }

  async sendPushNotification(expoPushToken, title, body, data = {}) {
    console.log('Push notification disabled in development:', title);
    return null;
  }

  // Helper methods for different types of notifications
  async notifyBookingConfirmed(bookingId, serviceName, caregiverName) {
    console.log('Booking confirmed notification disabled in development');
    return null;
  }

  async notifyNewMessage(senderName, messagePreview, conversationId) {
    console.log('New message notification disabled in development');
    return null;
  }

  async notifyBookingReminder(serviceName, caregiverName, scheduledTime) {
    console.log('Booking reminder notification disabled in development');
    return null;
  }

  async notifyPaymentReceived(amount, serviceName) {
    console.log('Payment received notification disabled in development');
    return null;
  }

  async notifyReviewRequest(serviceName, petOwnerName) {
    console.log('Review request notification disabled in development');
    return null;
  }
}
